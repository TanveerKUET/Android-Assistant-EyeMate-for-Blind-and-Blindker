...
public class EyemateActivity extends Activity{
	...
	private static final String insert_url_location = "http://demo.techspree.net/blindlocation/locationinsert.php";  //I used this before for Server which was Laptop via Wi-Fi
	...
	String latt,longi,time;
				...
				protected void onCreate(Bundle savedInstanceState) {
					...
					wL.acquire();
					setContentView(R.layout.eyemate_layout);
					...
					gvoice = MediaPlayer.create(EyemateActivity.this, R.raw.obstacleinground);
					lvoice = MediaPlayer.create(EyemateActivity.this, R.raw.obstacleinleft);
					rvoice = MediaPlayer.create(EyemateActivity.this, R.raw.obstacleinright);
				...
				protected void makeCall() {
					  ...
					  new getData().execute();
					  number = txtRecord.getText().toString();
				      Log.i("Make call", "");
				      ...
				      try {
				         ...
				         Toast.makeText(EyemateActivity.this, 
				...
				class InsertLocation extends AsyncTask<String, String, String>{
					  /**
						...
						protected void onPreExecute() {
							// TODO Auto-generated method stub
							super.onPreExecute();
							pDialog = new ProgressDialog(EyemateActivity.this);
							pDialog.setMessage("Inserting Location .....");
